...
export default function SignInInput() {
    ...
    return (
        <Stack align='center' className='mt-14' gap='lg'>
            ...
            <Text style={{maxWidth: '480px'}} ta='center'>Sign in with your email to gain access to the playlist. You must have use the same email that has a Premium tier subscription to <Anchor href='https://www.deepdivenewsletter.com/'>The Deep Dive newsletter</Anchor></Text>
            <TextInput type='email' error={error} value={email} onChange={(event) => setEmail(event.target.value)} 
                style={{maxWidth: '480px'}} w={{base: '65%', sm: '50%', md: '35%', lg: '%20'}} 
